...
/*   Updated: 2017/06/29 17:55:49 by alhelson         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
mglrect		gen_to_rect(t_layer_gen gen, t_v4f color)
{
	...
	rect_d = (mglrect){.flags = 0, .border_left = 0, .border_right = 0, .border_top = 0, .border_bottom = 0};
	...
	col = (t_v4f){color.x / 255.0, color.y / 255.0, color.z / 255.0, color.w / 255.0};
