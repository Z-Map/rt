...
/*   Updated: 2017/05/15 02:06:04 by qloubier         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
#  define RT_DBGM(rt, msg) rtd_msg(rt, 0, msg, RT_DBGI);
#  define RT_DBGMC(rt, code, msg) rtd_msg(rt, code, msg, RT_DBGI);
# else
#  define RT_DBGP(rt, code, name)
#  define RT_DBGR(rt, rcode, code, msg)
#  define RT_DBGM(rt, msg)
#  define RT_DBGMC(rt, code, msg)
# endif
